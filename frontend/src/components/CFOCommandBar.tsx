...
export function CFOCommandBar({ appData, userType }: CFOCommandBarProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex flex-col items-center gap-4">
      ...
      <button
        ...
        className="w-full flex items-center gap-3 px-5 py-3 rounded-full border border-border bg-card/80 backdrop-blur-sm shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-200 text-left"
      >
